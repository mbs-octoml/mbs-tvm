...
MNIST = {'name': 'mnist', 'filename': 'mnist-8.onnx', 'input_shapes': {'Input3': [1, 1, 28, 28]},
         'input_dtypes': {'Input3': "float32"}, 'main_dtype': "float32"}
GPT2 = {'name': 'gpt2', 'filename': 'gpt2.onnx', 'input_shapes': {'input1': [1, 50, 32]},
        'input_dtypes': {'input1': 'int64'}, 'main_dtype': "float32"}
RESNET50V2 = {'name': 'resnet50', 'filename': 'resnet50-v2-7.onnx', 'input_shapes': {'data': [1, 3, 224, 224]},
              'input_dtypes': {'data': 'float32'}, 'main_dtype': "float32"}
MOBILENETV2 = {'name': 'mobilenet', 'filename': 'mobilenetv2-1.0.onnx', 'input_shapes': {'data': [1, 3, 224, 224]},
               'input_dtypes': {'data': 'float32'}, 'main_dtype': "float32"}
# Note that resnext50_32_4d below was extracted directly from the pytorch model and not from any onnx file.
RESNEXT50_32_4d = {'name': 'resnext50_32_4d', 'filename': 'resnext50_32x4d.onnx',
                   'input_shapes': {'x': [1, 64, 56, 56]}, 'input_dtypes': {'x': 'float32'}, 'main_dtype': "float32"}
...
def mnist():
    ...
    return {'name': 'mnist', 'input_shapes': {"x": [1, 1, 28, 28]}, 'input_dtypes': {"x": "float32"}, 'mod': mod,
            'params': None, 'main_dtype': "float32"}
...
def gpt2():
    ...
    return {'name': 'gpt2', 'input_shapes': {"x": [1, 50, 32]}, 'input_dtypes': {"x": 'int64'}, 'mod': mod,
            'params': None, 'main_dtype': "float32"}
...
def gpt2_16():
    ...
    return {'name': 'gpt2_16', 'input_shapes': {"x": [1, 50, 32]}, 'input_dtypes': {"x": 'int64'}, 'mod': mod,
            'params': None, 'main_dtype': "float16"}
...
def gpt2_extract():
    ...
    return {'input_shapes': {"x": [1600, 768]}, 'input_dtypes': {"x": 'float32'}, 'mod': mod, 'params': None,
            'main_dtype': "float32"}
...
def gpt2_extract_16():
    ...
    return {'name': 'gpt2_extract', 'input_shapes': {"x": [1600, 768]}, 'input_dtypes': {"x": 'float16'}, 'mod': mod,
            'params': None, 'main_dtype': "float16"}
...
def resnet50():
    ...
    return {'name': 'resnet50', 'input_shapes': {'data': [1, 3, 224, 224]}, 'input_dtypes': {'data': 'float32'},
            'mod': mod, 'params': None, 'main_dtype': "float32"}
...
def mobilenet():
    ...
    return {'name': 'mobilenet', 'input_shapes': {'data': [1, 3, 224, 224]}, 'input_dtypes': {'data': 'float32'},
            'mod': mod, 'params': None, 'main_dtype': "float32"}
...
def batch_norm_extract():
    ...
    return {'name': 'batch_norm_extract', 'input_shapes': {'FunctionVar_0': [1, 32, 112, 112]},
            'input_dtypes': {'FunctionVar_0': 'float32'}, 'mod': mod, 'params': None, 'main_dtype': "float32"}
...
def resnext50_32x4d():
    ...
    return {'name': 'resnext50_32x4d', 'input_shapes': {'x': [1, 64, 56, 56]}, 'input_dtypes': {'x': 'float32'},
            'mod': mod, 'params': None, 'main_dtype': "float32"}
...
def from_onnx(model):
    ...
    mod, params = tvm.relay.frontend.from_onnx(onnx_model, model['input_shapes'], freeze_params=True)
    ...
    return {'name': model['name'], 'input_shapes': model['input_shapes'], 'input_dtypes': model['input_dtypes'],
            'mod': mod, 'params': params, 'main_dtype': model['main_dtype']}
...
def to_onnx(model):
    ...
    return {'name': model['name'], 'filename': short_filename, 'input_shapes': model['input_shapes'],
            'input_dtypes': model['input_dtypes'], 'main_dtype': model['main_dtype']}
