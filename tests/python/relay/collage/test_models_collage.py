...
models = {
    "mobilenet": [
        os.path.join(MODEL_PATH, "vision/classification/mobilenet/model/mobilenetv2-7.onnx"),
        {"input": [1, 3, 224, 224]},
        {"input": "float32"},
    ],
    "mnist": [
        os.path.join(MODEL_PATH, "vision/classification/mnist/model/mnist-1.onnx"),
        {"Input73": [1, 1, 28, 28]},
        {"Input73": "float32"},
    ],
    "squeezenet": [
        os.path.join(MODEL_PATH, "vision/classification/squeezenet/model/squeezenet1.0-12.onnx"),
        {"data_0": [1, 3, 224, 224]},
        {"data_0": "float32"},
    ],
    "vgg": [
        os.path.join(MODEL_PATH, "vision/classification/vgg/model/vgg19-7.onnx"),
        {"data": [1, 3, 224, 224]},
        {"data": "float32"},
    ],
    "resnet50-v1": [
        os.path.join(MODEL_PATH, "vision/classification/resnet/model/resnet50-v1-12.onnx"),
        {"data": [1, 3, 224, 224]},
        {"data": "float32"},
    ],
    "resnet18-v1.7": [
        os.path.join(MODEL_PATH, "vision/classification/resnet/model/resnet18-v1-7.onnx"),
        {"data": [1, 3, 224, 224]},
        {"data": "float32"},
    ],
    "efficientnet-lite": [
    ...
    "alexnet": [
        os.path.join(MODEL_PATH, "vision/classification/alexnet/model/bvlcalexnet-12.onnx"),
        {"data_0": [1, 3, 224, 224]},
        {"data_0": "float32"},
    ],
    "ssd": [
        os.path.join(MODEL_PATH, "vision/object_detection_segmentation/ssd/model/ssd-12.onnx"),
        {"image": [1, 3, 1200, 1200]},
        {"image": "float32"},
    ],
    "yolov3": [
    ...
    "gpt-2": [
        os.path.join(MODEL_PATH, "text/machine_comprehension/gpt-2/model/gpt2-10.onnx"),
        {"image": [3, 1, 1]},
        {"image": "float32"},
    ],
    "duc": [
